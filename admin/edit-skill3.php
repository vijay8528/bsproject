...
<head>
    ...
    function Validate(){
      ...
      //  var em = document.getElementById("email").value;
       ...
       if(sk==""){
        alert("Please Enter Your Skill Icon...");
        document.getElementById("skill").focus();
        return false;
       } 

       if(!isNaN(sk)){
        alert("Please Enter Valid Skill Icon!");
       ...
       if(sk.length<3){
        alert("Please Enter Atleast 3 Char Long Skill Icon!");
        document.getElementById("skill").value="";
        document.getElementById("skill").focus();
        return false;
       }
...
<a href="#"class="navbar-brand"><i class="fas fa-child text-warning fa-2x"></i></a>
 ...
 <div class="container-center">
           ...
           <h1 class="text-display-1">EDIT SKILL</h1>
    ...
    <div class="col-lg-6 col-md-8 col-sm-10">
     ...
     <div class="form-group">
      <label for="skill">Skill icon</label>
       <input type="text"class="form-control"id="skill"/>
         ...
         <div class="form-group">
          ...
          <button class="btn btn-warning btn-block"type="submit">Edit Skill</button>
    
    </form>
     
      <a href="skill.php"class="text-danger">Back</a>
