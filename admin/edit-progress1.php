...
<head>
    ...
    <script>
      ...
      //  var nm = document.getElementById("name").value;
       ...
       var pr = document.getElementById("parcentage").value;
    ...
    return false;
      ...
      if(ms==""){
        alert("Please Enter Your Project Parcentage %...");
        document.getElementById("message").focus();
        return false;
      } 

      if(!isNaN(ms)){
             alert("Please Enter Valid Message Name!");
      ...
      if(ms.length<3){
        alert("Please Enter Atleast 3 Char Long Message Name!");
        document.getElementById("message").value="";
        document.getElementById("message").focus();
        return false;
      }
      ...
      if(pr==""){
        alert("Please Enter Your Parcentage Color Class %...");
        document.getElementById("parcentage").focus();
        return false;
      } 

      if(!isNaN(pr)){
             alert("Please Enter Valid Parcentage Color Class %!");
             document.getElementById("parcentage").value="";
             document.getElementById("parcentage").focus();
             return false
      }

      if(pr.length<3){
        alert("Please Enter Atleast 3 Char Long Parcentage Color Class %!");
        document.getElementById("parcentage").value="";
        document.getElementById("parcentage").focus();
        return false;
      }
...
<a href="#"class="navbar-brand"><i class="fas fa-child text-warning fa-2x"></i></a>
 ...
 <div class="container-center">
    ...
    <h1 class="text-display-1">EDIT PROGRESS</h1>
...
<div class="form-group">
  <label for="message">Project Parcentage(%)</label>
  <input type="text"class="form-control"id="message"/>
</div> 

 <div class="form-group">
    <label for="parcentage">Parcentage color class</label>
    <input type="text" class="form-control"id="parcentage"/>                                  
</div>
<button class="btn btn-warning btn-block"type="submit">Edit Progress</button>
    </form>
     
  <a href="progress.php"class="text-danger">Back</a>
