    ...
    <script>
      function Validate(){
       ...
       if(em==""){
         ...
         if(!em.match(/^[A-Z a-z\._\-0-9]*[@][A-Z a-z]*[\.][a-z]{2,4}$/)){
             alert("Please Enter Valid Email Id...!");
            document.getElementById("email").focus();
             return false;
         }
        if(em.indexOf("@")<1 || em.lastIndexOf(".")<em.indexOf("@")+2 || em.lastIndexOf(".")+2>=em.length){
            alert("Please Enter Valid Email Id...!");
            document.getElementById("email").focus();
...
<a href="#"class="navbar-brand"><i class="fas fa-child text-warning fa-2x"></i></a>
 ...
 <div class="container-center">
            ...
            <h1 class="text-display-1">ADD CONTACT</h1>
...
<button class="btn btn-warning btn-block"type="submit">Add Contact</button>
    
    </form>
     
     <!-- <button class="btn btn-warning btn-block"type="submit">Add Contact</button>
     -->
      <a href="contact.php"class="text-danger">Back</a>
